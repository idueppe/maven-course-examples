...
======================
Examples, Exercises and Solutions for [Apache Maven] (http://maven.apache.org/). All projects are intended to be used for training purposes only.

License
=======
Maven Course Examples by 
Ingo DŸppe and Torsten Friebe 
